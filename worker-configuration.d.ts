/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6dbaf6283fcd5704e112831c5263cbd1)
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    ADMIN_SECRET: string
    GITHUB_TOKEN: string
    ANALYSIS_WORKFLOW: Workflow<Parameters<import('./src/server-entry').AnalysisWorkflow['run']>[0]['payload']>
  }
}
